# 学习副本说明:
# - 原始文件来自 external/mink_upstream/src/mink/tasks/relative_frame_task.py。
# - RelativeFrameTask 控制两个 frame 之间的相对位姿。
# - 阅读重点: 相对 transform 的 error/Jacobian 如何和 FrameTask 类似又不同。
