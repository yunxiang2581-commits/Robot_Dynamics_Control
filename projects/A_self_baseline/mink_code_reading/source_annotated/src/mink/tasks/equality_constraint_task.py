# 学习副本说明:
# - 原始文件来自 external/mink_upstream/src/mink/tasks/equality_constraint_task.py。
# - EqualityConstraintTask 用于表达需要精确满足的任务约束。
# - 阅读重点: 它和普通 least-squares task 在 QP 中的位置不同。
