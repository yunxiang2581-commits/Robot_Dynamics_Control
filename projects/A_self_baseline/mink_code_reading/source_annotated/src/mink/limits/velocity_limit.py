# 学习副本说明:
# - 原始文件来自 external/mink_upstream/src/mink/limits/velocity_limit.py。
# - VelocityLimit 把关节速度上限转换成 QP 不等式约束。
# - 阅读重点: max velocity 如何变成 dq 的上下界。
...
class VelocityLimit(Limit):
    # 学习提示: 这是最适合第一轮阅读的 limit，和 A05 的 velocity bound 直接对应。
    ...
    def compute_qp_inequalities(
        ...
        # 学习提示: QP 变量是 delta_q，因此速度上限需要乘以 dt 变成 step bound。
