...
# 宿主机脚本。
# 作用：在全部前置检查通过后，手动启动 walk_wbc viewer。
# 输入：
# - DISPLAY 和 /tmp/.X11-unix
# - R2_ROOT: C03 R2 build 产物
# - RUN_ROOT: 本轮输出目录
# 输出：
# - 运行日志写入 RUN_ROOT/logs
# - record 覆盖写入 RUN_ROOT/runtime_record
...
RUN_ROOT="/home/ubuntu/Robot_Dynamics_Control/projects/C_openloong_dyn_control_study/outputs/docker_reproduction/openloong_docker_nvidia_x11_check_R2/20260603_181426"
