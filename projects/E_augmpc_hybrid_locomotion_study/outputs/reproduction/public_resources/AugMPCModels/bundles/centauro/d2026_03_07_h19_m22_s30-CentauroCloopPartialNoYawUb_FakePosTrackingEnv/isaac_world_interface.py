...
class IsaacSimEnv(AugMPCWorldInterfaceBase):
    ...
    def _parse_env_opts(self):
        ...
        isaac_opts["step_height_ub"]=0.12
        ...
        isaac_opts["pert_wrenches_rate"]=30.0 # on average 1 pert every pert_wrenches_rate seconds
        isaac_opts["pert_wrenches_min_duration"]=0.6
        isaac_opts["pert_wrenches_max_duration"]=3.5 # [s]
        isaac_opts["pert_force_max_weight_scale"]=0.4 # clip force norm to scale*weight
        isaac_opts["pert_force_min_weight_scale"]=0.1 # optional min force norm as scale*weight
